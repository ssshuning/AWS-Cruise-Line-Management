...
class PostForm(forms.Form):
    post_text = forms.CharField(max_length=1000,label='New Post:')
...
class CommentForm(forms.Form):
    comment_text = forms.CharField(max_length=1000,label='New Comment:')
...
class UpdateForm(forms.ModelForm):
    class Meta:
        model = Profile
        fields = ( 'picture','bio')
        widgets = {'picture': forms.FileInput(attrs={'id':'id_profile_picture'}),'bio':forms.Textarea(attrs={'id':'id_bio_text'})}
